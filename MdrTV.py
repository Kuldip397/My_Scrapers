	              ####Python Script to download the recent video of MadridistaTV channel of youtube####

import requests
import bs4 as bs

url = 'https://www.youtube.com/user/elMadridistaTV/videos'
	                          	####To get the youtube link of the video#### 
...
videolink = video.get('href')
					...
					####To get the download link of the video####
